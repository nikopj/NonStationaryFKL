...
def main(argv, seed=88):
	...
	print(f"args.stationary={args.stationary}")
	if args.stationary:
		...
		data_mod = spectralgp.models.NonStatSpectralModel(train_x, train_y, data_lh, num_locs=args.nomg, period_factor=args.period_factor)
